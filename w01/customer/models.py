...
class NoticeBoard(models.Model):
  ...
  like_members = models.ManyToManyField(Member, related_name='like_noticeboards',  blank=True)
...
#   # img파일 업로드
#   pfile = models.ImageField(null=True, blank=True, upload_to='uploads/')
#   # 모든 파일 다 가능
#   # bimg = models.FileField(null=True)
...
#   def __str__(self):
#     return f'{self.pno}, {self.ptitle}, {self.pdate}'
